...
BEGIN
  ...
  IF _payment_id IS NOT NULL THEN
    ...
    -- Bonus que ja estava gravado no PIX
    ...
    -- Resolve a promocao efetiva: a ativa AGORA tem prioridade; senao usa a do PIX.
    ...
    IF _effective_promo_id IS NOT NULL THEN
      ...
      -- Atualiza referencia da promo no pagamento para auditoria
      ...
      -- Se a promo efetiva define um bonus maior do que ja foi pago, credita a diferenca
      ...
      -- Aplica piso de nivel (sem mexer na progressao de gasto)
