...
BEGIN
  ...
  PERFORM public.telegram_enqueue(
    '⚠️ <b>Pedido travado — permissão de Owner faltando</b>' || E'\n' ||
    '🗓 Venda: ' || _when || E'\n' ||
    ...
    '👉 O cliente convidou o bot mas <b>não deu permissão de Owner</b>. Ele precisa reconvidar o bot como <b>Owner</b> do workspace.'
  );
