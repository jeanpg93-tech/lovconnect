...
function Step2OwnerScreen({
  ...
  return (
    <StepShell
      ...
      subtitle={
        <>Quase lá! Agora promova nosso bot a <b>Owner</b> do workspace. Esse é o nível necessário para realizar a recarga dos recargas automaticamente.</>
      }
        ...
        <div className="relative overflow-hidden rounded-[calc(1rem-1.5px)] bg-zinc-950/85 backdrop-blur-xl p-6 text-center">
          ...
          <div className="relative">
            ...
            <h2 className="mt-1 font-display text-2xl sm:text-3xl font-bold text-white">
              {isDone ? "Recarga concluída! 🎉" : "Enviando seus recargas…"}
            </h2>
