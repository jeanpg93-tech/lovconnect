        ...
        <div className="text-center space-y-1.5 pt-1 px-2">
          <h1 className="text-xl sm:text-3xl font-extrabold tracking-tight text-white leading-tight text-balance">
            ...
            <span className="bg-gradient-to-r from-violet-300 via-fuchsia-300 to-violet-300 bg-clip-text text-transparent whitespace-nowrap">
              {totalCredits > 0 ? `${totalCredits.toLocaleString("pt-BR")} créditos` : "créditos"}
            </span>
          </h1>
...
function GeneratingInviteScreen() {
  ...
  const tips = [
    ...
    },
    {
      ...
      desc: "Assim que você convidar o bot, os créditos são depositados em segundos.",
    },
    {
      icon: RefreshCw,
...
function Step1EditorScreen({
  ...
  return (
    <StepShell
      ...
      subtitle={
        <>Para começar, adicione nosso bot no <b>seu workspace Lovable</b> com a permissão <b>Editor</b>. Ele vai precisar disso para preparar a transferência dos créditos.</>
      }
      ...
      whyText="Como Editor, nosso bot consegue ser reconhecido pelo seu workspace. No próximo passo você vai promovê-lo para Owner — só assim ele pode transferir os créditos para você de forma automática e segura."
      nextTitle="O que acontece depois"
      nextSteps={[
        "Validamos o convite em segundos",
        "Você libera o bot como Owner (Passo 2)",
        "Os créditos chegam automaticamente no seu workspace",
      ]}
      email={email}
      copied={copied}
      onCopy={onCopy}
...
function Step2OwnerScreen({
  ...
  return (
    <StepShell
      ...
      subtitle={
        <>Quase lá! Agora promova nosso bot a <b>Owner</b> do workspace. Esse é o nível necessário para realizar a recarga dos créditos automaticamente.</>
      }
      ...
      nextSteps={[
        ...
        "A entrega dos créditos começa em segundos",
        ...
        <div className="relative overflow-hidden rounded-[calc(1rem-1.5px)] bg-zinc-950/85 backdrop-blur-xl p-6 text-center">
          ...
          <div className="relative">
            ...
            <h2 className="mt-1 font-display text-2xl sm:text-3xl font-bold text-white">
              {isDone ? "Recarga concluída! 🎉" : "Enviando seus créditos…"}
            </h2>
            <p className="mt-2 text-sm text-zinc-300 max-w-md mx-auto">
              {isDone
                ? "Tudo pronto. Seus créditos já estão disponíveis no workspace."
                : "Nossos servidores estão transferindo os créditos automaticamente. Pode levar alguns instantes."}
            </p>

            {/* Contador animado de créditos */}
            <div className="mt-5 mx-auto max-w-sm">
              ...
              <div className="mt-1 text-xs text-zinc-400">créditos entregues</div>
      ...
      <div className="relative overflow-hidden rounded-[calc(1rem-1.5px)] bg-zinc-950/85 backdrop-blur-xl p-5 sm:p-6">
        ...
        <div className="relative rounded-xl border border-rose-400/30 bg-gradient-to-br from-rose-500/10 to-rose-500/[0.02] p-4 sm:p-5">
          <div className="flex flex-col items-center text-center gap-2">
            ...
            <p className="text-xs sm:text-sm text-rose-200/80">
              Solicite o cancelamento para receber os créditos em outra conta
            </p>
          </div>
          <p className="mt-3 text-xs sm:text-sm text-zinc-300 leading-relaxed text-center max-w-md mx-auto">
            ...
            indicação da Lovable. Para receber os créditos, solicite o cancelamento deste
        ...
        <div className="mt-5">
          <div className="flex items-center justify-between text-[11px] uppercase tracking-wider">
            <span className="font-semibold text-zinc-400">Créditos enviados</span>
          ...
          <p className="mt-2 text-center text-[11px] text-zinc-500">
            Esta página é atualizada automaticamente conforme os créditos vão sendo
            adicionados.
          </p>
        </div>
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="rounded-xl border border-white/5 bg-white/[0.02] px-3 py-1 divide-y divide-white/5">
              <Row label="Créditos iniciais" value={fmtNum(cg)} />
              <Row label="Consumo inicial" value={fmtNum(cu)} />
              <Row label="Créditos disponíveis" value={fmtNum(dispIni)} />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="rounded-xl border border-white/5 bg-white/[0.02] px-3 py-1 divide-y divide-white/5">
              <Row label="Créditos finais" value={fmtNum(cge)} />
              <Row label="Consumo final" value={fmtNum(cue)} />
              <Row label="Créditos disponíveis" value={fmtNum(dispFim)} />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="rounded-xl border border-violet-400/20 bg-violet-500/5 px-3 py-1 divide-y divide-white/5">
              <Row label="Créditos enviados" value={fmtNum(enviados)} accent />
              <Row label="Créditos recarregados" value={fmtNum(recarregados)} accent />
            </div>
          </div>
        </div>
      </div>
