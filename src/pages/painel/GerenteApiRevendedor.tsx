  ...
  return (
    <PageContainer>
      <PageHeader
        ...
        description="Documentação oficial da API de recarga de recarga para revendedores."
        icon={KeyRound}
      />
      ...
      <div className="rounded-2xl border border-border bg-card/60 p-6 backdrop-blur-sm">
        ...
        <div className="mt-4 grid gap-3 sm:grid-cols-3">
          {[
            ...
            { n: 3, t: "Compre recarga", d: "Consulte saldo, calcule orçamentos, crie e acompanhe pedidos." },
          ].map((s) => (
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <div className="rounded-xl border border-border bg-card/60 p-4 text-xs leading-relaxed">
          ...
          <div className="mt-3 space-y-2">
            <div><strong>Quantidade:</strong> 10 a 5000 recarga, em múltiplos de 10.</div>
  ...
  "data": {
    ...
    "saldoReais": "22.40"
      ...
      <DocBlock
        ...
        body={`# Calcula o preço para uma quantidade específica de recarga
...
# Resposta: o objeto completo do pedido (mesmo shape de GET /pedidos/{id})`}
      ...
      <DocBlock
        ...
        body={`# Só pode ser alterado antes de enviar recarga.
        ...
        <table className="mt-3 w-full text-xs">
          ...
          <tbody className="divide-y divide-border">
            {[
              ...
              ["recarregando", "Bot está recarregando os recarga no workspace."],
              ["entregando", "Entrega final em curso."],
              ["sucesso", "Recarga entregues com sucesso."],
