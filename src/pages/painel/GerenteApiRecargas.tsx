        ...
        <div className="flex items-start gap-3 rounded-xl border border-amber-500/40 bg-amber-500/5 p-4 text-sm">
          ...
          <div>
            ...
            <p className="mt-1 text-xs text-muted-foreground">
              Cole sua API key do Lovable Credits abaixo para habilitar as recarga automáticas.
            </p>
          </div>
        </div>
      )}
...
function buildFullDocsRevendedor() {
  return `# API Recarga Automáticas — Documentação Completa
...
3. Crie pedidos — Envie a quantidade de recarga e configure o tipo de entrega.
...
## Limites e Regras
- Recarga: múltiplos dos pacotes ativos no seu nível.
...
function buildFullDocsManual() {
  return `# API Recarga Manuais — Documentação Completa
      ...
      <Card className="border-border bg-card/60 p-6 backdrop-blur-sm">
        ...
        <div className="mt-4 grid gap-3 sm:grid-cols-3">
          {[
            ...
            { n: 3, t: "Crie pedidos", d: "Envie a quantidade de recarga e configure o tipo de entrega." },
          ].map(s => (
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Card className="border-border bg-card/60 p-4 text-xs leading-relaxed">
          ...
          <div className="mt-3 space-y-2">
            <div><strong>Recarga:</strong> múltiplos dos pacotes ativos no seu nível</div>
    ...
    <div className="space-y-4">
      ...
      <Card className="border-border bg-card/60 p-6 backdrop-blur-sm">
        ...
        <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          {[
            { n: 1, t: "Crie o pedido", d: "POST /pedidos-manual com recarga e tipo de entrega. Saldo é debitado na hora." },
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Card className="border-border bg-card/60 p-4 text-xs leading-relaxed">
          ...
          <ul className="mt-3 list-disc space-y-1 pl-4">
            ...
            <li><code className="font-mono">entregue</code> — recarga no workspace</li>
      ...
      <div className="rounded-xl border border-amber-500/30 bg-amber-500/5 p-4 text-xs text-muted-foreground">
        ...
        uma <strong>API Key separada</strong> (gere a "API Manual" na sua página de API Recarga). A chave
...
/* PÁGINA                                                              */
/* ================================================================== */
export default function GerenteApiRecarga() {
  return (
    <PageContainer>
      <div className="mb-4">
        <div className="flex items-center gap-2 text-xs uppercase tracking-wider text-muted-foreground">
          <Sparkles className="h-3.5 w-3.5" /> API Recarga
        </div>
            ...
            dashboard={
              <div className="space-y-4">
                <Card className="border-amber-500/30 bg-gradient-to-br from-amber-500/5 to-card/40 p-4 text-xs text-muted-foreground">
                  ...
                  Cada revendedor pode gerar a sua na página <em>API Recarga</em>.
                </Card>
