      ...
      <div className="rounded-2xl border border-border bg-card/60 p-6 backdrop-blur-sm">
        ...
        <div className="mt-4 grid gap-3 sm:grid-cols-3">
          {[
            ...
            { n: 3, t: "Crie pedidos", d: "Envie a quantidade de recarga e configure o tipo de entrega. O valor é debitado automaticamente." },
          ].map((s) => (
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div className="rounded-xl border border-border bg-card/60 p-5">
          ...
          <div className="mt-3 space-y-2 text-xs text-muted-foreground">
            <div className="text-[11px] font-mono uppercase tracking-wider text-foreground">Recarga</div>
            <ul className="list-disc pl-4 space-y-1">
              <li>Mínimo: <strong className="text-foreground">10</strong> recarga</li>
              <li>Máximo: <strong className="text-foreground">5.000</strong> recarga</li>
...
function TabErros() {
  const erros: Array<[string, string, string]> = [
    ...
    ["400", "INVALID_CREDITS", "Quantidade de recarga inválida (10-5000, múltiplos de 10)"],
    ["400", "MISSING_FIELDS", "Campos obrigatórios faltando"],
    ["400", "MISSING_CREDITS", "Parâmetro creditos não fornecido"],
    ["400", "CREDITS_NOT_MULTIPLE_OF_10", "Recarga deve ser múltiplo de 10"],
    ...
    ["400", "CREDITS_ALREADY_SENT", "Recarga já foram enviados, operação bloqueada"],
  ...
  const status: Array<[string, string, string]> = [
    ...
    ["recarregando", "info", "Bot fazendo farm de recarga no workspace"],
    ["entregando", "info", "Bot entregando/transferindo o workspace para o cliente"],
    ["sucesso", "success", "Recarga adicionados com sucesso"],
  ...
  return (
    <div className="space-y-5">
      <div className="rounded-xl border border-primary/20 bg-primary/5 p-4 text-xs leading-relaxed">
        ...
        o farm de recarga inicia automaticamente.
      </div>

      <StepCard n={1} title="Criar o pedido" subtitle="Debita o saldo e reserva os recarga">
      ...
      "workspace_nome": "Meu Workspace"
        ...
        <div className="space-y-2 text-xs">
          <div className="rounded-lg border border-emerald-500/30 bg-emerald-500/5 p-3">
            <strong className="font-mono text-emerald-600 dark:text-emerald-400">"confirmado"</strong>
            <p className="mt-1 text-muted-foreground">
              Bot entrou como Owner. O farm de recarga vai começar automaticamente. Siga para o passo 5.
            </p>
          </div>
          <div className="rounded-lg border border-amber-500/30 bg-amber-500/5 p-3">
            <strong className="font-mono text-amber-600 dark:text-amber-400">"permissao_incorreta"</strong>
  ...
  return (
    <div className="space-y-8">
      <section className="space-y-3">
        ...
        <p className="text-xs text-muted-foreground">
          Crie um pedido e entregue recarga em uma conta Lovable nova do cliente.
        </p>
...
/* ============ PAGE ============ */
export default function RevendedorApiRecarga() {
  return (
    <PageContainer>
      <PageHeader
        title={
          <h1 className="font-display text-3xl font-black tracking-tighter sm:text-5xl">
            API <span className="text-primary italic">Gerar Recarga</span>
          </h1>
        }
        description="Integre seu sistema para criar pedidos de recarga de recarga Lovable automaticamente."
        icon={KeyRound}
      />
