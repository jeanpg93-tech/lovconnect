...
export default function RevendedorCreditos() {
  ...
  const save = async () => {
    ...
    try {
      ...
      toast.success("Pacotes de créditos salvos");
      closeDialog();
      load();
    } catch (e: any) {
  ...
  return (
    <div>
      <PageHeader
        title="Meus preços — Créditos"
        description="Defina o preço de venda dos pacotes de créditos Lovable e acompanhe sua margem."
        actions={
      ...
      <div className="mb-5 flex items-start gap-3 rounded-xl border border-primary/30 bg-gradient-to-r from-primary/10 via-primary/5 to-transparent p-4">
        ...
        <div className="text-sm">
          ...
          <p className="mt-0.5 text-muted-foreground">
            Pacotes de <span className="text-foreground font-medium">100 créditos</span> costumam ter melhor conversão.
      ...
      <Dialog open={open} onOpenChange={(v) => !v && closeDialog()}>
        <DialogContent className="max-w-lg">
          <DialogHeader>
            <DialogTitle>Cadastrar preços de venda — Créditos</DialogTitle>
            <DialogDescription>
              Ative os pacotes de créditos que deseja vender e defina o preço final cobrado dos seus clientes.
            </DialogDescription>
          </DialogHeader>
