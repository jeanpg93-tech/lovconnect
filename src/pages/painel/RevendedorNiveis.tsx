          ...
          <div className="relative z-10 flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            ...
            <div className="flex flex-col items-end gap-3">
              <div className="rounded-3xl border border-white/5 bg-black/40 p-6 backdrop-blur-xl shadow-inner">
                <div className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/60 mb-1.5">Investimento Acumulado</div>
            ...
            <div className="relative z-10 space-y-8">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    <div className="text-[10px] font-black uppercase tracking-widest text-muted-foreground/60">Sua Patente Atual</div>
              ...
              {nextTier ? (
                <div className="space-y-5">
                  <div className="flex items-end justify-between">
                    <div>
                      <div className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest mb-1">Próxima Patente</div>
            ...
            <div className="relative z-10 flex flex-col justify-between h-full space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-muted-foreground font-bold">Vantagens garantidas pelo seu nível atual</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="rounded-3xl bg-black/40 p-5 border border-white/5 shadow-inner group-hover:border-primary/20 transition-colors">
                  <div className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest mb-1">Desconto</div>
                  <div className="text-2xl font-black text-primary">{tiers[currentIdx]?.discount_percent || 0}%</div>
                </div>
                <div className="rounded-3xl bg-black/40 p-5 border border-white/5 shadow-inner group-hover:border-primary/20 transition-colors">
                  <div className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest mb-1">Bônus PIX</div>
        ...
        <Card className="group relative overflow-hidden rounded-[3rem] border-white/5 bg-card/40 p-8 md:p-12 shadow-2xl backdrop-blur-xl transition-all hover:border-primary/20 border border-white/5">
          ...
          <div className="relative z-10 mb-12 flex items-center gap-5">
            ...
            <div>
              ...
              <p className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground/60">Mapa de patentes e requisitos</p>
            </div>
          </div>
