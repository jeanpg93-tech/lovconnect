...
const CATEGORIES = [
  ...
  { id: "creditos", name: "Créditos", icon: Coins, color: "text-emerald-400" },
        ...
        <div className="relative grid gap-8 p-6 md:p-12 lg:grid-cols-[1fr_0.8fr] lg:items-center">
          <div className="space-y-6">
            ...
            <p className="max-w-md text-sm md:text-base text-muted-foreground leading-relaxed">
              Explore todos os pacotes de créditos, licenças pro e serviços de personalização para alavancar sua revenda.
            </p>
