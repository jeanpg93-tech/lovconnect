  ...
  function buildCustomizationPayload() {
    ...
    return {
      ...
      payload: {
        ...
        popup_color_bg_elevated: "#141416",
        popup_color_bg_surface: "#1b1b1f",
        popup_card_bg_color: "#1b1b1f",
        popup_card_border_color: "rgba(255,255,255,0.08)",
        popup_card_border_hover_color: "rgba(255,255,255,0.14)",
        popup_card_text_color: "#f4f4f5",
        popup_card_muted_text_color: "#a1a1aa",
