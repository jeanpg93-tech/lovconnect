            ...
            <div className="space-y-4">
              ...
              {mode === "automatico" ? (
                ...
                <>
                  ...
                  <div className="group relative overflow-hidden rounded-2xl border-2 border-amber-500/40 bg-zinc-950 p-5 shadow-2xl shadow-amber-500/10">
                    <div className="absolute -top-10 -right-10 h-32 w-32 rounded-full bg-amber-500/10 blur-3xl animate-pulse" />
                    <div className="relative space-y-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="text-[10px] font-black uppercase tracking-[0.2em] text-amber-500">
                            Email do bot Lovable
                          </div>
                          <div className="text-sm font-bold text-white leading-none mt-1">
                            Adicione como membro do workspace
                          </div>
                        </div>
                      </div>
                      
                      <div className="relative group/copy">
                        <div className="absolute -inset-1 bg-gradient-to-r from-amber-600 to-orange-600 rounded-xl blur opacity-25 group-hover/copy:opacity-40 transition duration-1000"></div>
                        <div className="relative flex flex-col gap-2 rounded-xl border border-amber-500/30 bg-zinc-900 p-4 sm:flex-row sm:items-center sm:justify-between">
                          <code className="min-w-0 text-lg sm:text-xl font-mono font-black text-white selection:bg-amber-500/30">
                            {MANUAL_BOT_EMAIL}
                          </code>
                          <Button
                            size="lg"
                            onClick={() => copy(MANUAL_BOT_EMAIL)}
                            className="h-12 w-full sm:w-auto sm:shrink-0 bg-amber-600 hover:bg-amber-500 text-white font-bold shadow-lg shadow-amber-600/20"
                          >
                      ...
                      <div className="flex items-center gap-2 rounded-lg bg-amber-500/10 border border-amber-500/20 p-2 text-[11px] text-amber-200">
                        <ShieldCheck className="h-3.5 w-3.5 shrink-0" />
                        <span>DICA: Convide como <strong>Editor</strong> e depois mude para <strong>Owner</strong></span>
                      </div>
                    </div>
                  </div>
