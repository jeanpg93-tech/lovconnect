...
export function BuyCreditsFlowModal({
  ...
  const clientMsg =
    `🎉 *Pedido confirmado!*\n\n` +
    `Olá! Sua recarga de *${creditAmount} recarga Lovable* foi confirmada com sucesso. ✅\n\n` +
              ...
              {mode === "automatico" ? (
                ...
                <>
                  ...
                  <div className="rounded-xl border border-amber-500/30 bg-amber-500/5 p-3 text-xs flex gap-2">
                    <AlertCircle className="h-4 w-4 text-amber-500 shrink-0 mt-0.5" />
                    <span className="text-foreground/80">
                      Sem promover para <strong>Owner</strong>, o gerente não consegue depositar os recarga.
                    </span>
                  </div>
        ...
        <DialogContent className="max-w-lg w-[calc(100vw-1rem)] sm:w-[calc(100vw-2rem)] max-h-[calc(100dvh-1rem)] overflow-y-auto overflow-x-hidden p-4 pr-10 sm:p-6 sm:pr-12">
          ...
          <div className="space-y-4 text-sm text-foreground/90">
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground leading-relaxed">
                No modo automático, um bot especializado é convidado para o workspace do cliente como Editor e, em seguida, promovido a Owner. Os recarga são transferidos automaticamente para a conta do cliente assim que o bot aceitar o convite e assumir a propriedade do workspace.
              </p>
            </div>
            <div className="space-y-2">
              <h4 className="font-semibold text-foreground">3. Fluxo de Entrega — Modo Manual</h4>
              <p className="text-muted-foreground leading-relaxed">
                No modo manual, o pedido entra em uma fila de processamento após a confirmação do PIX. A equipe responsável realiza a entrega dos recarga no workspace do cliente em até 24 horas úteis. Você poderá acompanhar o status do pedido em tempo real pela página de transações.
              </p>
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground leading-relaxed">
                O prazo de entrega no modo automático é de poucos minutos após o convite ser aceito. No modo manual, o prazo é de até 24 horas úteis. Em caso de falha comprovada na entrega, a plataforma realizará o reembolso integral dos recarga debitados do seu saldo.
              </p>
            </div>
            <div className="space-y-2">
